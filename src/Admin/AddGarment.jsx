    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (video) {
                ...
                console.log("Uploaded video response:", res);
                uploadedVideo = {
                    public_id: res.public_id,
                    url: res.secure_url,
                };
            ...
            console.log("selected images and video:", images, video);
            await API.post("/garment/add", payload);
            ...
            console.error(error);
            toast.error(error.response?.data?.message || "Error adding garment");
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="w-full max-w-4xl backdrop-blur-xl bg-[#340B53] rounded-3xl shadow-2xl border border-[#e2b82e]">
                ...
                <div className="px-10 pt-10 pb-6 border-b border-slate-200 text-[#e2b82e]">
                    ...
                    <p className="text-sm mt-2">
                        Add garment with Buy & Rent (per day) pricing.
                    </p>
                </div>
                ...
                >
                    ...
                    <div>
                        ...
                        <textarea
                            name="description"
                            rows={4}
                            placeholder="Fabric, size, color, fitting details..."
